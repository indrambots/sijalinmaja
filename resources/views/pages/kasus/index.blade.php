...
@if(auth()->user()->level == AliasName::level_dinas)
    <ol class="breadcrumb breadcrumb-dot text-muted fs-6 fw-bold">
        ...
        <li class="breadcrumb-item px-3 text-muted">Data Kasus</li>
    </ol>
@endif
<div class="col">
    <div class="card">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-4">
                    <div class="d-flex justify-content-end">
                        <a href="{{ url('kasus/create/0')}} " type="button" class="btn btn-outline-primary m-b-xs ">
                            <i class="fas fa-plus-circle"></i> Input Data Kasus Baru
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                <form class="form" method="POST" action="{{url('kasus/modal/verif')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-inline">
                            <label class="radio">
                                ...
                                <span></span>BIDANG KETENTRAMAN DAN KETERTIBAN UMUM
                            </label>
                            <label class="radio">
                                <input type="radio" class="bidang" name="bidang" value="PENEGAKAN PERATURAN DAERAH">
                                <span></span>BIDANG PENEGAKAN PERATURAN DAERAH
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="alert alert-info" role="alert" id="alert_ba">
                        Berita acara sudah pernah dibuat silahkan
                        <a href="" id="link_ba" target="_blank"> KLIK DISINI </a> untuk mendownload BERITA ACARA
                    </div>
                ...
                <form class="form" method="POST" action="{{url('kasus/kasandra/save')}}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button type="button" onclick="lihatKasandra()" class="btn btn-lg btn-success border-0 font-weight-bold mr-2">
                                PILIH POTENSI PERDA YANG DILANGGAR
                            </button>
                        </div>
                    </div>
                </form>
