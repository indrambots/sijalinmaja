...
<body>
    <div class="page">
        <p class="s3" style="text-align:center;">
            Dokumentasi Kegiatan {{$kegiatan->bentuk_kegiatan}} {{$kegiatan->judul_kegiatan}}
        </p>
        <center>
            <img src="{{ url('storage/'.$kegiatan->dokumentasi_1) }}">
            <img src="{{ url('storage/'.$kegiatan->dokumentasi_2) }}">
            <img src="{{ url('storage/'.$kegiatan->dokumentasi_3) }}">
        </center>
    </div>
