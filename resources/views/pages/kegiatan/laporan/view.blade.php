...
<body>
    <div class="page">
        ...
        <center>
            <img src="{{ asset('storage/uploads/dokumentasi/'.$kegiatan->dokumentasi_1) }}">
            <img src="{{ asset('storage/uploads/dokumentasi/'.$kegiatan->dokumentasi_2) }}">
            <img src="{{ asset('storage/uploads/dokumentasi/'.$kegiatan->dokumentasi_3) }}">
        </center>
    </div>
