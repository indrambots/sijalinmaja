...
<body>
    ...
    <div class="page">
        ...
        @endif
        <br>
<table cellspacing="0" style="border-collapse:collapse;margin-left:35.075pt;border-color: white;">
    <tbody>
